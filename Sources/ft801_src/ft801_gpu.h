...
/* HOST COMMANDS */
#define FT_HOST_CMD_ACTIVE  (uint32_t)0x00000000    // switch from standby/sleep moedes to active mode
#define FT_HOST_CMD_STANBY  (uint32_t)0x00410000    // put ft801 core to standby mode
#define FT_HOST_CMD_SLEEP   (uint32_t)0x00420000    // put ft801 core to sleep mode
#define FT_HOST_CMD_PWRDOWN (uint32_t)0x00500000    // switch off 1.2V internal regulator. Clock, pll, oscilator off.
#define FT_HOST_CMD_CLKEXT  (uint32_t)0x00440000    // select PLL input from crystal or ext. input pin
#define FT_HOST_CMD_CLKINT  (uint32_t)0x00480000    // select PLL input form internal oscilator
#define FT_HOST_CMD_48M     (uint32_t)0x00620000    // PLL clk output = 48MHz (default)
#define FT_HOST_CMD_36M     (uint32_t)0x00610000    // PLL clk output = 36MHz
#define FT_HOST_CMD_CORERST (uint32_t)0x00680000    // Reset to FT801 core ( regs and state mach will be reset )
